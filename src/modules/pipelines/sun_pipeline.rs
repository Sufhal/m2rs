...
pub struct SunBindGroupLayouts {
...
pub struct SunPipeline {
    ...
    pub bind_group_layouts: SunBindGroupLayouts,
}
...
impl SunPipeline {
    pub fn new(
        ...
        Self {
            pipeline,
            pipeline_layout,
            bind_group_layouts: SunBindGroupLayouts { mesh },
        }
    }
    ...
    fn create_mesh_layout(device: &wgpu::Device) -> wgpu::BindGroupLayout {
        ...
        device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            entries: &entries,
            label: Some("Sun_mesh_bind_group_layout"),
        })
    }
