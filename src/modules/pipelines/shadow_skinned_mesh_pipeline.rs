...
use crate::modules::core::{directional_light::DirectionalLightUniform, instance::InstanceRaw, model::{SkinnedMeshVertex, Vertex}};
use super::skinned_models_pipeline::SkinnedModelPipeline;
...
pub struct ShadowSkinnedMeshPipeline {
...
impl ShadowSkinnedMeshPipeline {
    pub fn new(
        device: &wgpu::Device,
        ...
        let pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: Some("Shadow Skinned Mesh Pipeline Layout"),
            bind_group_layouts: &[
                &bind_group_layout,
                &skinned_models_pipeline.bind_group_layouts.mesh,
                &skinned_models_pipeline.bind_group_layouts.instances,
            ],
        ...
        let shader = device.create_shader_module(
            wgpu::ShaderModuleDescriptor {
                ...
                source: wgpu::ShaderSource::Wgsl(
                    include_str!("../../shaders/shadow_skinned_mesh.wgsl").into()
                ),
            }
        );
