...
pub struct SkinnedModelBindGroupLayouts {
    pub mesh: wgpu::BindGroupLayout,
    pub instances: wgpu::BindGroupLayout,
}

pub struct SkinnedModelPipeline {
    pub pipeline: wgpu::RenderPipeline,
    pub pipeline_layout: wgpu::PipelineLayout,
    pub bind_group_layouts: SkinnedModelBindGroupLayouts,
}

impl SkinnedModelPipeline {
    pub fn new(
        device: &wgpu::Device,
        ...
        let pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: Some("Skinned Models Pipeline Layout"),
            bind_group_layouts: &[
        ...
        Self {
            pipeline,
            pipeline_layout,
            bind_group_layouts: SkinnedModelBindGroupLayouts { mesh, instances },
        }
    }
    ...
    fn create_pipeline(
        ...
        device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            label: Some("Skinned Models Pipeline"),
            layout: Some(layout),
