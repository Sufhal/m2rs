...
pub struct CloudsBindGroupLayouts {
...
pub struct CloudsPipeline {
    ...
    pub bind_group_layouts: CloudsBindGroupLayouts,
}
...
impl CloudsPipeline {
    pub fn new(
        ...
        Self {
            pipeline,
            pipeline_layout,
            bind_group_layouts: CloudsBindGroupLayouts { mesh },
        }
    }
    ...
    fn create_mesh_layout(device: &wgpu::Device) -> wgpu::BindGroupLayout {
        ...
        device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            entries: &entries,
            label: Some("Clouds_mesh_bind_group_layout"),
        })
    }
        ...
        let shader = device.create_shader_module(
            wgpu::ShaderModuleDescriptor {
                ...
                source: wgpu::ShaderSource::Wgsl(
                    include_str!("../../shaders/clouds.wgsl").into()
                ),
            }
        );
